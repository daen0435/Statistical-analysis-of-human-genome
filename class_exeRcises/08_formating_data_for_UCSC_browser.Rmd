...
fl <- list.files("/scratch/Shares/rinnclass/CLASS_2022/daen0435/Statistical-analysis-of-human-genome/class_exeRcises/analysis/07_run_chipseq/data/results/bwa/mergedLibrary/macs/broadPeak/broad_peak", full.names = T)
summary(fl)
...
names(fl) <- gsub("/scratch/Shares/rinnclass/CLASS_2022/daen0435/Statistical-analysis-of-human-genome/class_exeRcises/analysis/07_run_chipseq/data/results/bwa/mergedLibrary/macs/broadPeak/broad_peak/|_peaks.broadPeak", "", fl)
...
peaks <- lapply(fl[1:10], read.table, col.names = c("chr", "start", "end", "name", "score", "strand", "signal_value", "pval", "qval"))
...
headers <- paste0("track type=broadPeak name=", names(fl)[1:10])
...
new_filenames <- paste0("/scratch/Shares/rinnclass/CLASS_2022/daen0435/Statistical-analysis-of-human-genome/class_exeRcises/analysis/07_run_chipseq/data/results/bwa/mergedLibrary/macs/broadPeak/broad_peak/", names(fl)[1:10], ".broadPeak")
